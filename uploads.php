            ...
            <div class="row-fluid">
                ...
                <div class="span6" id="content">
                     <div class="row-fluid">
					     ...
					     <ul class="breadcrumb">
							<li><a href="#">მომხარებელი:</a> <span class="divider">/</span></li>
							<li><a href="#"><b>ატვირთვა/ჩამოტვირთვა</b></a></li>
						</ul>
                        ...
                        <div id="block_bg" class="block">
							...
							Check All <input type="checkbox"  name="selectAll" id="checkAll" />
								...
								<?php
								if ($count == '0'){ ?>
								<div class="alert alert-info"><i class="icon-info-sign"></i> გადმოსაწერი ფაილი ვერ მოიძებნა.</div>
								<?php
								}else{
								?>
